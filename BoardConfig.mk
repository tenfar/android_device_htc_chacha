:# Copyright (C) 20t09 The Android Open Source Project
#
...
TARGET_PREBUILT_KERNEL := device/htc/chacha/prebuilt/kernel
LOCAL_KERNEL := device/htc/chacha/prebuilt/kernel
